...
&nbsp;
<h2>Schedule</h2>
<table style="height: 2175px;" width="816">
<tbody>
<tr>
<td width="375"><strong>Weekly Unit topics</strong></td>
<td width="191"><strong>Assessment</strong></td>
</tr>
<tr>
<td width="375"><strong>Unit 1: </strong><strong>Adult Learning Theory and Perspectives</strong>

1.    Reflective Practice and Teaching perspectives

2.    Critical and Transformative Learning

3.    Roles and factors impacting Adult Educators</td>
<td width="191">Blog Post (2%)

&nbsp;</td>
</tr>
<tr>
<td width="375"><strong>Unit 2: </strong><strong>Power, Self-Directed Learning, Transformative Learning </strong>

1.    Critical and Transformative Learning

2.    Pedagogy and Andragogy

3.    Prior needs assessment</td>
<td width="191">Reading Response (10%)
...
<tr>
<td width="375"><strong>Unit 3: </strong><strong>Experience, Emotions and Motivation </strong>

1.    Emotions and teaching

2.    Neuroscience and teaching

3.    Alternative methods to presenting

4.    Experiential learning</td>
<td width="191">Blog Post (2%)

&nbsp;</td>
</tr>
<tr>
<td width="375"><strong>Unit 4: </strong><strong>Goal, Objectives </strong>

1.    Writing Goals

2.    Writing Objectives</td>
<td width="191">Reading Response (10%)
...
<tr>
<td width="375"><strong>Unit 5: </strong><strong>Teaching for Critical Thinking  </strong>

1.    Techniques to foster Critical Thinking.

2.    The significance of Critical Thinking in adult learning.</td>
<td width="191">Blog Post (2%)

&nbsp;</td>
</tr>
<tr>
<td width="375"><strong>Unit 6: </strong><strong>Assessment</strong>
<ol>
 	<li>Assessment techniques -pre/during and post learning experiences</li>
</ol>
</td>
<td width="191">Reading Response (10%)
...
<tr>
<td width="375"><strong>Unit 7: Reading Break</strong></td>
<td width="191">Prepare Lesson Design Assignment</td>
</tr>
<tr>
<td width="375"><strong>Unit 8: </strong><strong>Democratizing Lifelong Learning  </strong>

1.    Authentic individualism

2.    Social Justice in Adult Education

3.    The adult educator as agent for social transformation.</td>
<td width="191">Reading Response (10%)
...
<tr>
<td width="375"><strong>Unit 9: </strong><strong>Opening Exercises, Discussion Methods, Active Training, Technology  </strong>

1.    Creating open exercises

2.    Designing, sequencing and planning active Training Activities

3.    Leading Discussions

4.    Giving Presentations</td>
<td width="191">Blog Post (2%)

&nbsp;

Post draft Adult Lesson Design assignment for Peer Review</td>
</tr>
<tr>
<td width="375"><strong>Unit 10: </strong><strong>Creativity, Structured Activities, Team Learning and Integration/implementation </strong>

1.    Creativity

2.    Team Learning

3.    Adult Educator Competencies</td>
<td width="191">Reading Response (10%)
