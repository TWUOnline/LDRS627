...
<ol>
 	...
 	<li>Read Sandlin, J., Redmon Wright R., Clark C. (2013). Reexamining Theories of Adult Learning and Adult Development through the Lenses of Public Pedagogy. <em>Adult Education Quarterly</em> 63:3, 14-16. <strong>(Adrienne, when do students read this?  I put it in topic 3)</strong></li>
...
<strong>Adrienne, when did you want students to read this:</strong>

<strong><span style="color: #3d85c6;font-family: arial, helvetica, sans-serif;font-size: large">W</span><span style="color: #3d85c6;font-family: arial, helvetica, sans-serif;font-size: large">ang, . C. X. (2017).</span><span style="color: #3d85c6;font-family: arial, helvetica, sans-serif;font-size: large"> </span><span style="color: #3d85c6;font-family: arial, helvetica, sans-serif;font-size: large"><i>Theory and Practice of Adult and Higher Education</i></span><span style="color: #3d85c6;font-family: arial, helvetica, sans-serif;font-size: large">. Information Age Publishing Inc. Chapter 10</span></strong>

&nbsp;
<h2>Topic 1: Critical Transformative Learning (new page)</h2>
<h4>Introduction</h4>
<strong>[Could we have an introduction sentence, perhaps that defines transformative learning in your own words?] </strong>With respect to transformative learning, instructors need to:
<ol>
